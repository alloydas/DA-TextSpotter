...
_C.MODEL.SWINT.OUT_FEATURES = ["stage3", "stage4", "stage5"]
_C.MODEL.SWINT.DEPTHS = [2, 6, 2]
_C.MODEL.SWINT.NUM_HEADS = [6, 12, 24]
...
_C.MODEL.BACKBONE.NAME = "build_lambdaresnet_backbone"
...
_C.MODEL.TRANSFORMER.LOSS.REG_TEXT_WEIGHT = 1.0
...
# SWINTV1 backbone
_C.MODEL.SWINTV1 = CN()
_C.MODEL.SWINTV1.EMBED_DIM = 96
_C.MODEL.SWINTV1.OUT_FEATURES = [ "stage3", "stage4", "stage5"]
_C.MODEL.SWINTV1.DEPTHS = [2, 2, 6, 2]
_C.MODEL.SWINTV1.NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.SWINTV1.WINDOW_SIZE = 7
_C.MODEL.SWINTV1.MLP_RATIO = 4
_C.MODEL.SWINTV1.DROP_PATH_RATE = 0.2
_C.MODEL.SWINTV1.APE = False
_C.MODEL.BACKBONE.FREEZE_AT = -1



_C.MODEL.NUMBER_OF_CHANNEL = [512, 1024, 2048]


# SWINTV2 backbone
_C.MODEL.SWINTV2 = CN()
_C.MODEL.SWINTV2.EMBED_DIM = 192
_C.MODEL.SWINTV2.OUT_FEATURES = ["stage2", "stage3", "stage4"]
_C.MODEL.SWINTV2.DEPTHS = [2, 2, 18, 2]
_C.MODEL.SWINTV2.NUM_HEADS = [6, 12, 24, 48]
_C.MODEL.SWINTV2.WINDOW_SIZE = 16
_C.MODEL.SWINTV2.MLP_RATIO = 4
_C.MODEL.SWINTV2.DROP_PATH_RATE = 0.2
_C.MODEL.SWINTV2.APE = False
_C.MODEL.BACKBONE.FREEZE_AT = -1
_C.MODEL.SWINTV2.PRETRAINED_WINDOW_SIZES = [16, 16, 16, 16]

_C.MODEL.SWINT = CN()
_C.MODEL.SWINT.EMBED_DIM = 128
_C.MODEL.SWINT.OUT_FEATURES = ["stage3", "stage4", "stage5"]
_C.MODEL.SWINT.DEPTHS = [2, 2, 6, 2]
_C.MODEL.SWINT.NUM_HEADS = [4, 8, 16, 32]
_C.MODEL.SWINT.WINDOW_SIZE = 7
_C.MODEL.SWINT.MLP_RATIO = 4.0
_C.MODEL.SWINT.DROP_PATH_RATE = 0.3
_C.MODEL.SWINT.APE = False
_C.MODEL.BACKBONE.FREEZE_AT = -1