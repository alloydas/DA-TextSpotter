...
def build_swintv1_backbone(cfg, input_shape):
    """
    ...
    return SwinTransformer(
        ...
        embed_dim=cfg.MODEL.SWINTV1.EMBED_DIM,
        depths=cfg.MODEL.SWINTV1.DEPTHS,
        num_heads=cfg.MODEL.SWINTV1.NUM_HEADS,
        window_size=cfg.MODEL.SWINTV1.WINDOW_SIZE,
        mlp_ratio=cfg.MODEL.SWINTV1.MLP_RATIO,
        qkv_bias=True,
        qk_scale=None,
        drop_rate=0.,
        attn_drop_rate=0.,
        drop_path_rate=cfg.MODEL.SWINTV1.DROP_PATH_RATE,
        norm_layer=nn.LayerNorm,
        ape=cfg.MODEL.SWINTV1.APE,
        patch_norm=True,
...
@BACKBONE_REGISTRY.register()
def build_swintv1_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
